    ...
    <section className={`${styles.section} mt-10 mr-10 ml-10 mb-15`}>
      ...
      <div className={styles.infoWrapper}>
        <div className={`${styles.info} mr-5`}>
          ...
          <span className="text_type_digits-default text_color_inactive">{props.calories}</span>
        </div>
        <div className={`${styles.info} mr-5`}>
          <span className="text_type_main-default text_color_inactive mb-2">Белкти, г</span>
          <span className="text_type_digits-default text_color_inactive">{props.proteins}</span>
        </div>
        <div className={`${styles.info} mr-5`}>
          <span className="text_type_main-default text_color_inactive mb-2">Жиры, г</span>
          <span className="text_type_digits-default text_color_inactive">{props.fat}</span>
        </div>
        <div className={styles.info}>
          <span className="text_type_main-default text_color_inactive mb-2">Углеводы, г</span>
          <span className="text_type_digits-default text_color_inactive">{props.carbohydrates}</span>
        </div>
      </div>
    </section>
  );
